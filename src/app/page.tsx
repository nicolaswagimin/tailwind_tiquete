      ...
      <div className="w-full max-w-5xl bg-white rounded-3xl shadow-sm border-2 border-amber-500/80 overflow-hidden">
        <div className="flex items-stretch">
          ...
          <div className="w-14 bg-neutral-900 text-white relative flex items-center justify-center">
            <div className="absolute -left-3 top-6 size-6 bg-neutral-100 rounded-full border border-neutral-200"></div>
            <div className="absolute -left-3 bottom-6 size-6 bg-neutral-100 rounded-full border border-neutral-200"></div>
