export default function Home() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-amber-500 p-6">
      <div className="w-full max-w-5xl bg-white rounded-3xl shadow-sm overflow-hidden">
        <div className="flex items-stretch">
          ...
          <div className="w-px bg-gradient-to-b from-transparent via-neutral-200 to-transparent relative">
            <div className="absolute -left-2 -top-3 size-6 bg-amber-500 rounded-full border border-neutral-200"></div>
            <div className="absolute -left-2 -bottom-3 size-6 bg-amber-500 rounded-full border border-neutral-200"></div>
          </div>
          ...
          <div className="w-14 bg-neutral-900 text-white relative flex items-center justify-center">
            <div className="absolute -left-3 top-6 size-6 bg-amber-500 rounded-full border border-neutral-200"></div>
            <div className="absolute -left-3 bottom-6 size-6 bg-amber-500 rounded-full border border-neutral-200"></div>
